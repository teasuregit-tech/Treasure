        ...
        <main className="relative w-full pl-0 md:pl-24">
          ...
          <div className="px-6 md:px-12 pt-8 md:pt-12 pb-8 flex flex-col md:flex-row justify-between items-start md:items-end">
              <div className="mb-2 md:mb-0">
                  ...
                  {/* TYPOGRAPHY: Oswald for Main Heading */}
          ...
          <div className="px-6 md:px-12 mb-16 md:mb-24">
              <div className="text-center mb-8 md:mb-10">
                  {/* TYPOGRAPHY: Oswald for Section Title */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                          {/* TYPOGRAPHY: Oswald for Banner Title */}
              ...
              >
                  {currentImages.map((item) => (
                      <div key={item.id} className="group cursor-pointer" onClick={() => setExpandedImageSrc(item.src)}>
                          ...
                          <div>
                              {/* TYPOGRAPHY: Oswald for Item Title */}
                              <h4 className={`font-['Oswald'] font-bold tracking-[0.1em] uppercase text-sm mb-1 transition-colors ${isDark ? 'text-[#EBEBE6]' : 'text-[#4A342B]'}`}>
                                  {item.title}
                              </h4>
                              {/* TYPOGRAPHY: Playfair for Item Subtitle */}
                              <p className={`text-xs font-['Playfair_Display'] italic ${isDark ? 'text-white/70' : 'text-[#8C7B6C]'}`}>
                                  {item.subtitle}
                              </p>
                          </div>
                      </div>
